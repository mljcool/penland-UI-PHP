    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <div class="dropdown-menu-header border-bottom">
            <div class="dropdown-header d-flex align-items-center py-3">
              ...
              <a
                ...
                aria-label="Menus"
                data-bs-original-title="Current Menu items may change based on account."
                ><i class="menu-icon tf-icons bx bx-spreadsheet"></i
              ></a>
            </div>
          </div>
          <div
            class="dropdown-shortcuts-list scrollable-container ps ps--active-y"
          >
      ...
      >
        ...
        <ul class="dropdown-menu dropdown-menu-end py-0">
          ...
          <li
            class="dropdown-notifications-list scrollable-container ps ps--active-y"
          >
            ...
            <div
              class="ps__rail-y"
              style="top: 528px; right: 0px; height: 480px"
            >
              <div
                class="ps__thumb-y"
                tabindex="0"
                style="top: 252px; height: 228px"
              ></div>
            </div>
          </li>

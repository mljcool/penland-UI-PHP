   ...
   <div class="container-xxl flex-grow-1">
      <div class="row mt-5">
         ...
         <div class="col-12 col-lg-4">
            <div class="card mb-4">
               <div class="card-header">
                  <h6 class="card-title m-0">Workshop Details</h6>
               </div>
               <div class="card-body">
                  <div class="d-flex justify-content-start align-items-center mb-4">
                     <div class="flex-shrink-0 d-flex align-items-center">
                        <img src="" alt="Penland Workshop" class="rounded w-px-100 imageurl"
                           style="border-radius: 8px; height: 100px;" />
                     </div>
                  </div>
                  <p class=" mb-1">
                  <h6 class="mb-0 workShopName">-------</h6>
                  </p>
                  <p class=" mb-1">Code: <span class="badge rounded-pill bg-label-success courseNumber">____</span></p>

                  <p class=" mb-1">Level: <span class="workshoplevel">-----</span></p>
                  <p class=" mb-1">Type: <span class="hsoWorkshoptype">-----</span></p>
                  <p class=" mb-0">Studio: <span class="studioType">-----</span></p>
               </div>
            </div>

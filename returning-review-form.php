...
<div id="review-details" class="content">
   ...
   <div class="row g-3">
                        ...
                        <div class="col-md-6">
                           <div class="border rounded p-4 mb-3 pb-3 white-background">
                              ...
                              <dl class="row mb-0">
                                 ...
                                 <dd class="col-6 text-end total-application-fee">
                                    $00.00
                                 </dd>
                        ...
                        <div class="col-md-6">
                           <div class="border rounded p-4 mb-3 pb-3 white-background">
                              ...
                              <dl class="row mb-0">
                                 ...
                                 <dd class="col-6 text-end">May 28, 2024</dd>

                                 <dt class="col-6 fw-normal">Transaction ID</dt>
                                 <dd class="col-6 text-end">#1536548131</dd>

                                 <dt class="col-6 fw-normal">Transaction Charges</dt>
                                 <dd class="col-6 text-end">$00.00</dd>
                              </dl>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="card message-success" style="display: none">
                        <div class="card-body">
                           ...
                           <p style="text-align: left; font-size: 18px" class="typing">
                              ...
                              Rest assured that your application is now in our hands, and our dedicated team will review
                              it thoroughly.<br /> We understand the importance of this process and assure you that
                              we'll give your application the attention it deserves.<br /> You will receive an email
                              from us soon with further details regarding the status of your application.<br /><br />
      ...
      <div class="col-12 d-flex justify-content-between ">
         ...
         <button class="btn btn-success btn-submit final-button-steps-retuning-student footer-btns">
            Submit
         </button>
      </div>
   </div>

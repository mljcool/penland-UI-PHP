            ...
            <div class="card mb-4">
               ...
               <div class="card-body">
                  <div class="d-flex align-items-start align-items-sm-center gap-4">
                     <img src="./assets/Avatar.png" alt="user-avatar" class="d-block rounded hso_photo" height="100"
               ...
               <div class="card-body">
                  <form id="formAccountSettings" method="GET" onsubmit="return false">
                              ...
                              <div class="col">
                                 <fieldset>
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <input type="text" id="lastName" name="lastName" class="form-control dd-lastname"
                                          placeholder="Doe" />
                                    </div>
                                    <div class="col-md-9 mt-3">
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <select class="select2 w-auto dd-gendercode" name="gender" id="gender"
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <select class="select2 w-auto dd-mshied_homelanguage" name="mshied_homelanguage"
                                          id="mshied_homelanguage" data-style="btn-transparent" data-icon-base="bx"
                                          data-tick-icon="bx-check text-white"></select>
                                    </div>
                                    <div class="col-md-9 mt-3">
                                 ...
                                 <fieldset>
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <select class="select2 w-auto dd-mshied_race_" name="mshied_race_"
                                          id="mshied_race_" data-style="btn-transparent" data-icon-base="bx"
                                          data-tick-icon="bx-check text-white"></select>
                                    </div>
                                    <div class="col-md-9 mt-3">
                                       <label class="form-label" for="hso_blackindigenousorpersonofcolor">Black,
                                          Indigenous, or Person of
                                          Color</label>
                                       <select class="select2 w-auto dd-hso_blackindigenousorpersonofcolor"
                                          name="hso_blackindigenousorpersonofcolor"
                                          id="hso_blackindigenousorpersonofcolor" data-style="btn-transparent"
                                    ...
                                    <div class="col-md-9 mt-3">
                                       <label class="form-label" for="mshied_limitedlanguageproficiency">Limited
                                          Language Proficiency+
                                          Identification</label>
                                       <select class="select2 w-auto dd-mshied_limitedlanguageproficiency"
                                          name="mshied_limitedlanguageproficiency"
                                          id="mshied_limitedlanguageproficiency" data-style="btn-transparent"
                                          data-icon-base="bx" data-tick-icon="bx-check text-white">
                                          <option label=""></option>
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <input type="text" name="mshied_accommodations" id="mshied_accommodations"
                                          class="form-control dd-mshied_accommodations" placeholder="here..." />
                                    </div>
                                    <div class="col-md-9 mt-3">
                                       <label class="form-label" for="hso_lgbtqiaidentification">Disability</label>
                                       <select class="select2 w-auto dd-mshied_disability" name="mshied_disability"
                                          id="mshied_disability" data-style="btn-transparent" data-icon-base="bx"
                                          data-tick-icon="bx-check text-white">
                                          <option label=""></option>
                                          <option value="1">Yes</option>
                                          <option value="2">No</option>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <input type="email" name="emailTwo" id="emailTwo"
                                          class="form-control dd-emailaddress2" placeholder="sample@email.co" />
                                    </div>
                                 </div>
                                 <div class="row mt-3">
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <input type="email" id="mailing-address" name="mailingAddress"
                                          class="form-control dd-emailaddress3" placeholder="Mailing Address..." />
                                    </div>
                                    <div class="col-md-9 mt-3">
                                       <label class="form-label" for="city">City</label>
                                       <input type="text" name="cityAddress" id="city"
                                          class="form-control dd-address1_city" placeholder="city Address..." />
                                    </div>
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <select class="select2 w-auto dd-address1_stateorprovince"
                                          ...
                                          name="stateProvince" data-icon-base="bx" data-tick-icon="bx-check text-white"
                                    ...
                                    <div class="col-md-9 mt-3">
                                       ...
                                       <input type="text" id="Postcode" name="zipcode"
                                          class="form-control dd-address1_postalcode" placeholder="ZIP Postcode..." />
                                    </div>
                                    <div class="col-md-9 mt-3">
                                       <label class="form-label" for="country-code">Country</label>
                                       <select class="select2 w-auto dd-address1_country" id="address1_country"
                                          data-style="btn-transparent" name="country" data-icon-base="bx"
                                          data-tick-icon="bx-check text-white" data-allow-clear="true"></select>
                                    </div>
                                 </div>
                              </fieldset>
                           </div>
                     ...
                     <div class="mt-2">
                        <hr class="my-4" />
                        <button type="submit" class="btn btn-primary me-2" id="submitProfileDetails">
                           Save changes
                        </button>

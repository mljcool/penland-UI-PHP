...
b?a.observer.trigger(a.observer.events.knownStatusesChanged,[b]):a.observer.trigger(a.observer.events.unknownStatusesChanged,[!0]);c(a)})},b=function(a){c(a);d(a);return jQuery.extend(this,a)};jQuery.fn.jplist.controls.BackButton=function(a){return new b(a)};jQuery.fn.jplist.controlTypes["back-button"]={className:"BackButton",options:{}}})();(function(){var c=function(b){b.$control.on("click",function(){$('.search-result-header').hide();$('.search-result-count').hide();$('.jplist-reset-btn').hide();b.observer.trigger(b.observer.events.unknownStatusesChanged,[!0])})},d=function(b){c(b);return jQuery.extend(this,b)};
jQuery.fn.jplist.controls.Reset=function(b){;return new d(b)};jQuery.fn.jplist.controlTypes.reset={className:"Reset",options:{}}})();
